...
describe("getAuthorList", () => {
  ...
  it("should format fullname as empty string if both first name and family name are absent", async () => {
    // Define the sorted authors list as we expect it to be returned by the database
    const sortedAuthors = [
      {
        first_name: "Jane",
  ...
  it("should format lifespan correctly if date of death is missing", async () => {
    // Define the sorted authors list as we expect it to be returned by the database
    const sortedAuthors = [
      {
        first_name: "Jane",
  ...
  it("should format lifespan correctly if date of birth is missing", async () => {
    // Define the sorted authors list as we expect it to be returned by the database
    const sortedAuthors = [
      {
        first_name: "Jane",
  ...
  it("should format lifespan correctly if date of birth and date of death are missing", async () => {
    // Define the sorted authors list as we expect it to be returned by the database
    const sortedAuthors = [
      {
        first_name: "Jane",
